...
public class NormalizeText {
    ...
    public static String noSpaceQuotes(String line) {
        ...
        for (int i = 0; i < stringBuffer.length(); i++) {
            if (stringBuffer.charAt(i) == '"' && countQuetes % 2 == 0) {
                stringBuffer.deleteCharAt(i + 1);//check lai
                countQuetes++;
    ...
    public static int countLine() {
        int countLine = 0;
        try {
            BufferedReader br = new BufferedReader(new FileReader(new File("E:/LAB211-OOP with Java Lab/WEEK_4/normalizeText/src/   test.txt")));
